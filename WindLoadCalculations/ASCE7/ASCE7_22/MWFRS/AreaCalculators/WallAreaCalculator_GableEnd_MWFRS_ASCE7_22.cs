...
{
    public class WallAreaCalculator_GableEnd_MWFRS_ASCE7_22 : AreaCalculator_MWFRS_ASCE7_22_Base
    {
        public WallAreaCalculator_GableEnd_MWFRS_ASCE7_22(BuildingData bldg_data, string note_string="")
        {
        ...
        public override void ComputeEffectiveWindAreas()
        {
            ...
            Point ridge = new Point(0.5 * length, buildingData.BuildingHeight + Math.Tan(buildingData.RoofPitch * Math.PI / 180.0) * length / 2.0);
