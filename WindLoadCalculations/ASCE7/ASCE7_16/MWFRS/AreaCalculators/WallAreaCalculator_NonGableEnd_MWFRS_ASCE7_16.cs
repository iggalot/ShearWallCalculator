...
{
    public class WallAreaCalculator_NonGableEnd_MWFRS_ASCE7_16 : AreaCalculator_MWFRS_ASCE7_16_Base
    {
        public WallAreaCalculator_NonGableEnd_MWFRS_ASCE7_16(BuildingData bldg_data, string note_string = "")
        {
