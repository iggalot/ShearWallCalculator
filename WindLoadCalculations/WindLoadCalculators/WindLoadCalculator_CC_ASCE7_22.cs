...
namespace ShearWallCalculator.WindLoadCalculations
{
    ...
    /// </summary>
    public class WindLoadCalculator_CC_ASCE7_22: WindLoadCalculator_Base
    {
        ...
        {
            extGCpCurve = new Figure30_3_2A_ASCE7_22();
        }
        ...
        private void GetExtGCpCurve_GableRoof(WindLoadParameters_Base p)
        {
            ...
            {
                extGCpCurve = new Figure30_3_2B_ASCE7_22();
            }
            else if (buildingData.RoofPitch <= 27)
            {
                extGCpCurve = new Figure30_3_2C_ASCE7_22();
            }
            else if (buildingData.RoofPitch <= 45)
            {
                extGCpCurve = new Figure30_3_2D_ASCE7_22();
            }
            else
            {
