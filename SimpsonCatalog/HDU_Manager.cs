...
{
    public class HDU_Manager : BaseSimpsonConnectorManager<HDU_Data>
    {
        ...
        public override List<HDU_Data> GetTypedModelsExceedingMinLoad(double reqLoad, WoodTypes woodType)
