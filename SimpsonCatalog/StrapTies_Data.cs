...
namespace ShearWallCalculator
{
    ...
    /// </summary>
    /// 
    public class StrapTies_FastenerConfig
    {
        // Fastener Info
    ...
    {
        Dictionary<string, StrapTies_Data> StrapTies = new Dictionary<string, StrapTies_Data>();
        ...
        {
            // ST2115
            StrapTies.Add("ST2115", new StrapTies_Data
            {
                Model = "ST2115",
                Gauge = 20,
                W = 0.75,
            ...
            // LSTA9
            StrapTies.Add("LSTA9", new StrapTies_Data
            {
                Model = "LSTA9",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA12
            StrapTies.Add("LSTA12", new StrapTies_Data
            {
                Model = "LSTA12",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA15
            StrapTies.Add("LSTA15", new StrapTies_Data
            {
                Model = "LSTA15",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA18
            StrapTies.Add("LSTA18", new StrapTies_Data
            {
                Model = "LSTA18",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA21
            StrapTies.Add("LSTA21", new StrapTies_Data
            {
                Model = "LSTA21",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA24
            StrapTies.Add("LSTA24", new StrapTies_Data
            {
                Model = "LSTA24",
                Gauge = 20,
                W = 1.25,
            ...
            // LSTA30
            StrapTies.Add("LSTA30", new StrapTies_Data
            {
                Model = "LSTA30",
                Gauge = 18,
                W = 1.25,
            ...
            // LSTA36
            StrapTies.Add("LSTA36", new StrapTies_Data
            {
                Model = "LSTA36",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA9
            StrapTies.Add("MSTA9", new StrapTies_Data
            {
                Model = "MSTA9",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA12
            StrapTies.Add("MSTA12", new StrapTies_Data
            {
                Model = "MSTA12",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA15
            StrapTies.Add("MSTA15", new StrapTies_Data
            {
                Model = "MSTA15",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA18
            StrapTies.Add("MSTA18", new StrapTies_Data
            {
                Model = "MSTA18",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA21
            StrapTies.Add("MSTA21", new StrapTies_Data
            {
                Model = "MSTA21",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA24
            StrapTies.Add("MSTA24", new StrapTies_Data
            {
                Model = "MSTA24",
                Gauge = 18,
                W = 1.25,
            ...
            // MSTA30
            StrapTies.Add("MSTA30", new StrapTies_Data
            {
                Model = "MSTA30",
                Gauge = 16,
                W = 1.25,
            ...
            // MSTA36
            StrapTies.Add("MSTA36", new StrapTies_Data
            {
                Model = "MSTA36",
                Gauge = 16,
                W = 1.25,
            ...
            // MSTA49
            StrapTies.Add("MSTA49", new StrapTies_Data
            {
                Model = "MSTA49",
                Gauge = 16,
                W = 1.25,
            ...
            // ST9
            StrapTies.Add("ST9", new StrapTies_Data
            {
                Model = "ST9",
                Gauge = 16,
                W = 1.25,
            ...
            // ST12
            StrapTies.Add("ST12", new StrapTies_Data
            {
                Model = "ST12",
                Gauge = 16,
                W = 1.25,
            ...
            // ST18
            StrapTies.Add("ST18", new StrapTies_Data
            {
                Model = "ST18",
                Gauge = 16,
                W = 1.25,
            ...
            // ST22
            StrapTies.Add("ST22", new StrapTies_Data
            {
                Model = "ST22",
                Gauge = 16,
                W = 1.25,
            ...
            // HRS6
            StrapTies.Add("HRS6", new StrapTies_Data
            {
                Model = "HRS6",
                Gauge = 12,
                W = 1.375,
            ...
            // HRS8
            StrapTies.Add("HRS8", new StrapTies_Data
            {
                Model = "HRS8",
                Gauge = 12,
                W = 1.375,
            ...
            // HRS8
            StrapTies.Add("HRS12", new StrapTies_Data
            {
                Model = "HRS12",
                Gauge = 12,
                W = 1.375,
            ...
            // ST292
            StrapTies.Add("ST292", new StrapTies_Data
            {
                Model = "ST292",
                Gauge = 20,
                W = 2.0625,
            ...
            // ST2122
            StrapTies.Add("ST2122", new StrapTies_Data
            {
                Model = "ST2122",
                Gauge = 20,
                W = 2.0625,
            ...
            // ST2215
            StrapTies.Add("ST2215", new StrapTies_Data
            {
                Model = "ST2215",
                Gauge = 20,
                W = 2.0625,
            ...
            // ST6215
            StrapTies.Add("ST6215", new StrapTies_Data
            {
                Model = "ST6215",
                Gauge = 16,
                W = 2.0625,
            ...
            // ST6224
            StrapTies.Add("ST6224", new StrapTies_Data
            {
                Model = "ST6224",
                Gauge = 16,
                W = 2.0625,
            ...
            // ST6236
            StrapTies.Add("ST6236", new StrapTies_Data
            {
                Model = "ST6236",
                Gauge = 14,
                W = 2.0625,
            ...
            // MSTI26
            StrapTies.Add("MSTI26", new StrapTies_Data
            {
                Model = "MSTI26",
                Gauge = 12,
                W = 2.0625,
            ...
            // MSTI36
            StrapTies.Add("MSTI36", new StrapTies_Data
            {
                Model = "MSTI36",
                Gauge = 12,
                W = 2.0625,
            ...
            // MSTI48
            StrapTies.Add("MSTI48", new StrapTies_Data
            {
                Model = "MSTI48",
                Gauge = 12,
                W = 2.0625,
            ...
            // MSTI60
            StrapTies.Add("MSTI60", new StrapTies_Data
            {
                Model = "MSTI60",
                Gauge = 12,
                W = 2.0625,
            ...
            // MSTI72
            StrapTies.Add("MSTI72", new StrapTies_Data
            {
                Model = "MSTI72",
                Gauge = 12,
                W = 2.0625,
            ...
            // HTP37Z
            StrapTies.Add("HTP37Z", new StrapTies_Data
            {
                Model = "HTP37Z",
                Gauge = 16,
                W = 3,
            ...
            // MSTC28
            StrapTies.Add("MSTC28", new StrapTies_Data
            {
                Model = "MSTC28",
                Gauge = 16,
                W = 3,
            ...
            // MSTC40
            StrapTies.Add("MSTC40", new StrapTies_Data
            {
                Model = "MSTC40",
                Gauge = 16,
                W = 3,
            ...
            // MSTC52
            StrapTies.Add("MSTC52", new StrapTies_Data
            {
                Model = "MSTC52",
                Gauge = 16,
                W = 3,
            ...
            // MSTC66
            StrapTies.Add("MSTC66", new StrapTies_Data
            {
                Model = "MSTC66",
                Gauge = 14,
                W = 3,
            ...
            // MSTC78
            StrapTies.Add("MSTC78", new StrapTies_Data
            {
                Model = "MSTC78",
                Gauge = 14,
                W = 3,
            ...
            // HRS416Z
            StrapTies.Add("HRS416Z", new StrapTies_Data
            {
                Model = "HRS416Z",
                Gauge = 12,
                W = 3.25,
            ...
            // LSTI49
            StrapTies.Add("LSTI49", new StrapTies_Data
            {
                Model = "LSTI49",
                Gauge = 18,
                W = 3.75,
            ...
            // LSTI73
            StrapTies.Add("LSTI73", new StrapTies_Data
            {
                Model = "LSTI73",
                Gauge = 18,
                W = 3.75,
        ...
        public List<string> GetStrapTieModelsExceedingMinLoad(double req_load, WoodTypes woodType)
        {
            ...
            foreach (KeyValuePair<string, StrapTies_Data> strapEntry in StrapTies)
            {
                var strapData = strapEntry.Value;
                ...
                foreach (var fastener in strapData.FastenerOptions)
                {
                    ...
                    if (fastener.AllowableTensionLoads.ContainsKey(wood_type_string))
                    {
                        ...
                        {
                            matchingModels.Add(strapData.Model);
        ...
        {
            string str = "";
            foreach (KeyValuePair<string, StrapTies_Data> hdu in StrapTies)
            {
